...
- [ ] Scheduling mechanism for playback source changes (by [hjdx2009](https://github.com/cheatsnake/airstation/issues/7#issue-3059402373))
...
- [ ] More online music source adapters
...
- [x] NetEase source quality and login cookie settings
- [x] Apple Music-like lyrics with word, synced-line, and plain-text fallbacks
